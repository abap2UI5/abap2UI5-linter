  ...
  return {
    ...
    properties: {
      ...
      badge: {
        ...
        description: 'Write shields.io endpoint JSON for every run, so the README can show what the corpus IS ("abap2UI5 | 148 apps · 172 views · 2,176 controls") and what the gate said about it ("check-abap2UI5 | 134 rules passed").',
      },
      rules: {
        type: 'object',
        additionalProperties: false,
